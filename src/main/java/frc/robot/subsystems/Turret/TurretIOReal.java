...
public class TurretIOReal implements TurretIO {
  ...
  public void setGoal(double goal) {
    ...
    if(!readyToShoot() && this.goal < TurretConstants.tubingAngle) {
    turretMotor.setControl(control.withPosition(this.goal).withFeedForward(TurretConstants.tubingFeedForward * ((TurretConstants.tubingAngle - this.goal))));
