...
public class EverythingAimAtHub extends Command {
  ...
  public void execute() {
    ...
    shooter.setVelocityRPS(
        ShooterConstants.shooterVelocityHubMap.get(drive.getTurretDistanceToHub()));
    hood.setGoal(ShooterHoodConstants.shooterHoodHubMap.get(drive.getTurretDistanceToHub()));
